          ...
          <div className="container-fluid">
            <div className="row margin-bottom-6">
              <div className="col-md-12">
                ...
                <img src={DecisionsDiagram} alt="decisions" />
              </div>
            </div>
            <div className="row equal margin-bottom-6">
              ...
              <div className="col-md-offset-1 col-md-5">
                <img src={TreeDiagram} alt="tree diagram" />
              </div>
            ...
            <div className="row equal">
              <div className="col-md-12">
                ...
                <p>
                  Your decision may add new lore and art to your descendants,
                  and you may receive new lore and art from your ancestors.
                </p>
              </div>
              <div className="col-md-offset-1 col-md-5">
                <img src={InheritanceDiagram} alt="inheritance" />
              </div>
              <div className="col-md-4 v-center-children">
                <div className="card">
                  <p>
            ...
            <div className="row">
              <div className="col-sm-12">
                ...
                <p>
                  ...
                  Karth to become the universe you envision.
                </p>
              </div>
            </div>
            <div className="row">
